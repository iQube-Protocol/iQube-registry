    ...
    <div className="flex items-start justify-between mb-8">
      <div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => navigate('/add')} className="bg-gradient-to-r from-blue-500 to-purple-600 ml-4 md:hidden px-2">
            <Plus className="w-4 h-4 mr-1" />
            Add iQube
          </Button>
        </div>
      </div>
      <Button onClick={() => navigate('/add')} className="bg-gradient-to-r from-blue-500 to-purple-600 hidden md:block px-6">
